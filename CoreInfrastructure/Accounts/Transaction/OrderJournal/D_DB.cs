...
namespace CoreInfrastructure.Accounts.Transaction.OrderJournal
{
    public class D_DB
    {
	 ...
	 select  isnull(max(cast(right(voucherid, 4) as bigint)),1000)	  as code 
        ...
        public string getUpdateMasterCount(string WHERE)
        {
            ...
            strsql = @"SELECT ISNULL(MAX(CAST(VoucherId AS bigint)),0)   as code   FROM Orderjournal_header WHERE " + WHERE;
        ...
        public M_Header GetSingle(string whereCondition)
        {
            ...
            strsql = "select * from Orderjournal_header where   " + whereCondition;
            sqldr = dp.ExecuteReader(con, strsql);
            ...
            //  fields.Orderjournal_Detail = GetDetailRowForEdit(whereCondition); 
        ...
        public List<M_Detail> GetDetailRowForEdit(string whereCondition)
        {
            ...
            strsql = "select * from Orderjournal_Detail where   " + whereCondition;
        ...
        public int Delete_Voucher_for_Edit_mode(string where)
        {
            ...
            strsql = "delete  from Orderjournal_Detail where " + where;
            SqlCommand cmd = new SqlCommand(strsql, con);
        ...
        public void Set_a(int Mode, M_Header m)
        {
            ...
            strsql = "Execute sp_cash_journal " + Mode.ToString() + ",";
            strsql += m.Id + ",";
        ...
        public void Set_detail(int Mode, M_Detail m)
        {
            ...
            strsql = "Execute sp_cash_journal_detail " + Mode.ToString() + ",";
            strsql += m.ID + ",";
            strsql += "'" + m.COMPANY_CODE.Replace("'", "''") + "',";
            strsql += "'" + m.VoucherId.Replace("'", "''") + "',";
            strsql += m.SeqNo + ",";
